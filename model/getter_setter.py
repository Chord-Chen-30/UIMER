...
def bert_getter(model, inputs_dict):
    ...
    def get_hook(i):
        def hook(module, inputs, outputs=None):
            if i == 0:
                ...
                # inputs (64, 84)
                # outputs (64, 84, 768) --word embedding
    ...
    # print(" We run forward before hook's working!!!")
    # pdb.set_trace()
